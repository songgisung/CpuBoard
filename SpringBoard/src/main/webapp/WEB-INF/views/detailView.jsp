...
<h3 style="text-align: center;">cpu在庫確認</h3>
<table>
	<tr>
		<th>番号</th>
		<td>${vo.idx}</td>
...
<%--  	 	<c:if test="${vo.filename[0] != null}" >
		...
		<td colspan ="2">
			<img src="/upload/${vo.fileName1}" width="300" height="300">
		</td>	
	...
	<tr>
		<td colspan="4" style="text-align:center;">
			...
			<img src="/upload/${vo.fileName2 }" width="500" />
		</td>
	</tr>
	<tr>
		<td colspan="4" style="text-align:right;">
			<input type="button" value="修正" onclick="location.href='/myapp/board/updateview?idx=${vo.idx }&exec=update&page=${page }'">
			<input type="button" value="削除" onclick="location.href='/myapp/board/deleteview?idx=${vo.idx }&exec=delete&page=${page }'">
			<input type="button" value="目録" onclick="location.href='/myapp/board/list'">
		<%-- "/myapp/board/view?idx=${vo.idx}" --%>
